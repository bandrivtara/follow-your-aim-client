...
2. Зістав об'єктивні дані трекера із настроєм, енергією, перемогами й перешкодами зі щоденних оглядів.
...
export const buildWeeklyReviewExport = ({
  ...
  const lines = [
    ...
    "",
    trackerSection.replace("# Витяг із трекера Follow Your Aim", "# Дані трекера"),
    "",
    "# Щоденні огляди",
  ];
